...
VERSION=4.2.94
PKGVERSION=
SRC_PATH=/home/giacomo/Desktop/tesi/qemu
...
TOOLS=qemu-ga$(EXESUF) ivshmem-client$(EXESUF) ivshmem-server$(EXESUF) qemu-nbd$(EXESUF) qemu-storage-daemon$(EXESUF) qemu-img$(EXESUF) qemu-io$(EXESUF) qemu-edid$(EXESUF)  fsdev/virtfs-proxy-helper$(EXESUF) scsi/qemu-pr-helper$(EXESUF)
ROMS=optionrom
MAKE=make
INSTALL=install
...
QEMU_INCLUDES=-iquote $(SRC_PATH)/tcg/i386 -isystem $(SRC_PATH)/linux-headers -isystem /home/giacomo/Desktop/tesi/qemu/build/linux-headers -iquote . -iquote $(SRC_PATH) -iquote $(SRC_PATH)/accel/tcg -iquote $(SRC_PATH)/include -iquote $(SRC_PATH)/disas/libvixl
